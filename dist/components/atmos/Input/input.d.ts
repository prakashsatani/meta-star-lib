...
declare const Input: ({ elementType, type, className, containerClassName, name, label, value, options, selectChildren, forwardedRef, hasSelectArrow, addTruncateFixForIosDevices, ...props }: props) => import("react/jsx-runtime").JSX.Element | null;
