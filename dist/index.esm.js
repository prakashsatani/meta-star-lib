...
function r(r){function t(t,i,a,o){var f=i?e+t+r.e+i:e+t,v=f;if(a){var s=' '+v+r.m;for(var u in a)if(a.hasOwnProperty(u)){var p=a[u];!0===p?v+=s+u:p&&(v+=s+u+n+p);}}if(void 0!==o)for(var y=0,c=(o=Array.isArray(o)?o:[o]).length;y<c;y++){var l=o[y];if(l&&'string'==typeof l.valueOf())for(var g=l.valueOf().split(' '),d=0;d<g.length;d++){var h=g[d];h!==f&&(v+=' '+h);}}return v}var e=r.n||'',n=r.v||r.m;return function(r,e){return function(n,i,a){return 'string'==typeof n?'string'==typeof i||Array.isArray(i)?t(r,n,void 0,i):t(r,n,i,a):t(r,e,n,i)}}}Object.defineProperty(classname_production_min,'__esModule',{value:!0});var t=r({e:'-',m:'_'});classname_production_min.cn=t,classname_production_min.withNaming=r;
	return classname_production_min;
}

if (process.env.NODE_ENV === 'production') {
  classname$1.exports = requireClassname_production_min();
} else {
  classname$1.exports = requireClassname_development();
}
...
var cns = /*@__PURE__*/getDefaultExportFromCjs(classnamesExports);
...
var classname = classnameExports.withNaming({
    n: '',
    e: '__',
    m: '--',
 ...
 * @param string[] strArr
 */
var classnameWithArraySupport = function (block) {
    var rest = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        rest[_i - 1] = arguments[_i];
    }
    if (!Array.isArray(block)) {
        return classname.apply(void 0, __spreadArray([block], rest, false));
    }
    var classNameArray = block
        .filter(function (item) { return item; })
        .map(function (item) {
        if (Array.isArray(item)) {
            //@ts-expect-error not an error
            return classname.apply(void 0, item);
        }
        else {
    ...
    return function () {
        ...
        return cns(classNameArray.map(function (cn) { return cn.apply(void 0, params); }));
    };
};
...
var Label = function (_a) {
    ...
    var cn = classnameWithArraySupport("label-atom");
    return React.createElement("label", { className: cns(cn(), className) }, children);
};

var Input = function (_a) {
    var _b, _c, _d;
    var _e = _a.elementType, elementType = _e === void 0 ? "input" : _e, _f = _a.type, type = _f === void 0 ? "text" : _f, _g = _a.className, className = _g === void 0 ? "" : _g, _h = _a.containerClassName, containerClassName = _h === void 0 ? "" : _h, name = _a.name, _j = _a.label, label = _j === void 0 ? "" : _j, _k = _a.value, value = _k === void 0 ? undefined : _k, _l = _a.options, options = _l === void 0 ? [] : _l, _m = _a.selectChildren, selectChildren = _m === void 0 ? undefined : _m; _a.forwardedRef; _a.hasSelectArrow; var _p = _a.addTruncateFixForIosDevices, addTruncateFixForIosDevices = _p === void 0 ? false : _p, props = __rest(_a, ["elementType", "type", "className", "containerClassName", "name", "label", "value", "options", "selectChildren", "forwardedRef", "hasSelectArrow", "addTruncateFixForIosDevices"]);
    var cn = classnameWithArraySupport("input-atom");
    // <input>
    if (elementType === "input") {
        return (React.createElement("div", { className: cns(cn(), containerClassName) },
            label && React.createElement(Label, { htmlFor: name }, label),
            React.createElement("input", __assign({ className: cns(cn((_b = {},
                    _b[elementType] = true,
                    _b[type] = true,
                    _b), className)), name: name, type: type, value: value }, props))));
    }
    // <textarea>
    if (elementType === "textarea") {
        return (React.createElement("div", { className: cns(cn(), containerClassName) },
            label && React.createElement(Label, { htmlFor: name }, label),
            React.createElement("textarea", __assign({ className: cns(cn((_c = {},
                    _c[elementType] = true,
                    _c), className)), name: name }, props, { value: value }))));
    }
    // <select>
    if (elementType === "select") {
        return (React.createElement("div", { className: cns(cn(), containerClassName) },
            label && React.createElement(Label, { htmlFor: name }, label),
            React.createElement("select", __assign({ className: cns(cn((_d = {},
                    _d[elementType] = true,
                    _d), className)), name: name, value: value }, props),
                options.length > 0 &&
                    options.map(function (_a) {
                        var label = _a.label, _b = _a.value, value = _b === void 0 ? "" : _b, optionProps = __rest(_a, ["label", "value"]);
                        return (React.createElement("option", __assign({ key: value, value: value, className: cn("option") }, optionProps), label));
                    }),
                selectChildren,
                addTruncateFixForIosDevices &&
                    window.navigator.userAgent.match(/(iPad|iPhone|iPod touch);/i) && (React.createElement("optgroup", { label: "" })))));
    }
    return null;
};

export { Input, classnameWithArraySupport as classname, cns as classnames, cns };
